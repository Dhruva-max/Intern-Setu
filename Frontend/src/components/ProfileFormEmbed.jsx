...
export default function ProfileFormEmbed({ airtableEmbedUrl }) {
  return (
    <div className="rounded-2xl border p-3">
      <div className="mb-3 text-sm text-slate-600">If the Airtable form fails to load, use the simplified in-app form below.</div>
...
function SimpleFallbackForm() {
  // small accessible fallback for low bandwidth users
  return (
